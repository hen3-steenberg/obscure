#ifndef OBSCURE_HELPER_TEMPLATES_MAX_SET_BIT_DEFINITION
#define OBSCURE_HELPER_TEMPLATES_MAX_SET_BIT_DEFINITION 1
#include <concepts>
#include <bit>
#include <type_traits>
...
namespace obscure
{
    namespace helper_templates
    {
        ...
        template<typename T>
        constexpr auto max_set_bits() = delete;

        template<std::unsigned_integral TEnum>
        constexpr auto max_set_bits(TEnum Flag)
        {
