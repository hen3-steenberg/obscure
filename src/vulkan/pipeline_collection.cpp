	...
	: shaders()
{
	...
	std::array<VkGraphicsPipelineCreateInfo, 1> pipeline_create_infos = { static_triangle_config.parse_configuration(context->swap_chain.render_pass, loaded_shaders) };
