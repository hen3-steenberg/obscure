...
#include <cstdint>
#include <tuple>
export module obscure.helper_templates.parent_reference;
...
namespace obscure::helper_templates
{
    ...
    constexpr TParent&
    get_parent_ref_impl(raw_ptr_t<TParent> _this)
    {
    ...
    export template<typename TParent, typename... TSiblings>
    constexpr TParent&
    get_parent_ref(raw_ptr_t<TParent> _this)
    {
