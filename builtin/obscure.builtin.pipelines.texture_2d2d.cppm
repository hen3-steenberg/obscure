...
export module obscure.builtin.pipelines.texture_2d2d;
...
export namespace obscure::builtin::pipeline
{
    ...
    struct texture_2d2d_vertex {
        glm::vec2 position;
        glm::vec2 texture_coord;
    };

    struct texture_2d2d {
        using shader_list = obscure::make_set<obscure::builtin::shader::texture_2d2d_vertex,
...
#pragma region shaders_fixed_functions
            auto result = obscure::vulkan::default_pipeline_builder<1,
                ...
                samples,
                shaders,
                { vk::VertexInputBindingDescription{ 0, sizeof(texture_2d2d_vertex), vk::VertexInputRate::eVertex } },
                { vk::VertexInputAttributeDescription{
                      0, 0, vk::Format::eR32G32Sfloat, offsetof(texture_2d2d_vertex, position) },
                  vk::VertexInputAttributeDescription{
                      1, 0, vk::Format::eR32G32Sfloat, offsetof(texture_2d2d_vertex, texture_coord) } });
...
#pragma endregion
        ...
        struct draw_calls : obscure::vulkan::draw_call_base {
            ...
            using triangles_t = obscure::vulkan::vertex_buffer<texture_2d2d_vertex>;
    ...
    static_assert(obscure::vulkan::pipeline_definition<texture_2d2d>);
