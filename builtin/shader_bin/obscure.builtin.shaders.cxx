...
template<>
size_t get_builtin_size<shader::color_vertex>() {
    constexpr size_t size = sizeof(color_vert);
    return get_actual_size(size);
}

template<>
size_t get_builtin_size<shader::texture_2d2d_vertex>()
{
...
template<>
std::span<const uint32_t> obscure::builtin::get_data<shader::color_vertex>()
{
...
template<>
std::span<const uint32_t> obscure::builtin::get_data<shader::texture_2d2d_vertex>()
{
