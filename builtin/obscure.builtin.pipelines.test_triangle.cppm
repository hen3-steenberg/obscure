...
export namespace obscure::builtin::pipeline
{
    struct test_triangle {
        using shader_list =
            obscure::make_set<obscure::builtin::shader::test_triangle_vertex, obscure::builtin::shader::color_fragment>;
...
#pragma region pipeline_layout
            vk::PipelineLayoutCreateInfo pipeline_info{ {}, 0, nullptr, 0, nullptr };
