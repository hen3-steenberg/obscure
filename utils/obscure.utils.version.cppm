...
#include <bit>
#include <cstdint>
export module obscure.utils.version;
...
export namespace obscure
{
    struct version {
        ...
        constexpr explicit version(uint32_t vers) noexcept { *this = std::bit_cast<version, uint32_t>(vers); }
