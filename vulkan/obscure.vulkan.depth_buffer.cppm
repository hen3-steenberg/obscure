...
export namespace obscure::vulkan
{
    ...
    private:
        ...
        static vk::Format get_format(device const& device_)
        {
            static constexpr std::array formats = {vk::Format::eD32SfloatS8Uint, vk::Format::eD24UnormS8Uint, vk::Format::eD32Sfloat, vk::Format::eD16UnormS8Uint, vk::Format::eD16Unorm};
    ...
    public:
        ...
        void free(device const& device_) noexcept
        {
                device_.waitIdle();
                for (size_t idx = 0; idx < buffer_count; ++idx)
                {
