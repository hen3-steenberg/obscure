...
export namespace obscure::vulkan
{
    struct transfer_session {
      ...
      public:
        ...
        transfer_session(obscure::vulkan::device const& _device,
                         vk::CommandPool _command_pool,
                         vk::CommandBuffer gfx_buffer)
        ...
        template<VkBufferUsageFlags Usage1,
        ...
        void
        transfer_data(buffer_impl<Usage1, MemoryUsage1, Flags1, Alignment> const& data_src,
                      ...
                      vk::DeviceSize size = VK_WHOLE_SIZE)
        {
            ...
            if constexpr (can_write<Flags1>()) {
                vmaFlushAllocation(data_src.vk_device->get_vma_allocator(), data_src.allocation, 0, VK_WHOLE_SIZE);
            }
        ...
        void
        copy_buffer_to_texture(buffer_impl<Usage, MemoryUsage, Flags, Alignment> const& data_src,
                               rgba_2d_texture<modeU, modeV, modeW>& data_dst)
        {
            ...
            graphics_command_buffer.copyBufferToImage(
                data_src.get_buffer(), data_dst.get_image(), vk::ImageLayout::eTransferDstOptimal, 1, &copy_region);
