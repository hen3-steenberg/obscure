...
export namespace obscure::vulkan
{
    ...
    private:
        static vk::SampleCountFlagBits get_sample_count(vk::PhysicalDevice device) noexcept
        {
            auto properties = device.getProperties();
            vk::SampleCountFlags sample_count = properties.limits.framebufferColorSampleCounts & properties.limits.framebufferDepthSampleCounts;
            if (sample_count & vk::SampleCountFlagBits::e64) return vk::SampleCountFlagBits::e64;
            if (sample_count & vk::SampleCountFlagBits::e32) return vk::SampleCountFlagBits::e32;
            if (sample_count & vk::SampleCountFlagBits::e16) return vk::SampleCountFlagBits::e16;
            if (sample_count & vk::SampleCountFlagBits::e8) return vk::SampleCountFlagBits::e8;
            if (sample_count & vk::SampleCountFlagBits::e4) return vk::SampleCountFlagBits::e4;
            if (sample_count & vk::SampleCountFlagBits::e2) return vk::SampleCountFlagBits::e2;
    ...
    public:
        ...
        void free(device const& device_)
        {
            for (size_t idx = 0; idx < max_image_count(); ++idx)
            {
